        ...
        {regions.map(({ key, label }) => (
          <label
            ...
            className={cn(
              ...
              // The mark, not a gate: a tinted row reads at a glance as one the
              // agency already serves, and every other row stays as clickable as
              // it was.
              highlighted.has(key) && 'border-primary/30 bg-primary/5',
