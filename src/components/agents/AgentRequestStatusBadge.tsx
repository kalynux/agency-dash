...
const STATUS_MAP: Record<AgentRequestStatus, { label: string; dot: string; className: string }> = {
...
export function AgentRequestStatusBadge({ status }: { status: AgentRequestStatus }) {
