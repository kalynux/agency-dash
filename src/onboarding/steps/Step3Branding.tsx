        ...
        <OnboardingLayout stepKey={3} viewingStepOverride={3}
            ctaSlot={
                <div className="px-6 pb-6 pt-2 space-y-2">
                    ...
                    <Button type="button" variant="ghost" onClick={handleSkip} disabled={isSubmitting || isSkipping} className="w-full h-11 text-muted-foreground hover:text-foreground gap-1.5 text-sm">
            ...
            <div className="px-6 pt-6 pb-4 border-b border-border/60">
                <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-lg font-bold text-foreground">{t('branding.title')}</h1>
                    </div>
