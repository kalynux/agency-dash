...
| `headquarters_addresses[].support_contact.phone` | `string` | Yes | **E.164** — leading `+` and country code required (e.g. `+237670000000`). [Contact formats](../README.md) | Phone number for this location. |
| `headquarters_addresses[].support_contact.email` | `string \| null` | No | Valid email, lowercased. [Contact formats](../README.md) | Contact email for this location. |
...
| `phone_number` | `string` | Yes | **E.164** — leading `+` and country code required (e.g. `+237670000000`). [Contact formats](../README.md) |
